\documentclass[reqno,12pt,twoside,a4paper]{report}
...
{
  justification   = justified,  %<--centering subfigure caption text
  singlelinecheck = false,
  font            = scriptsize, %<--font size for subfigures
  belowskip       = 2pt,
  format          = hang
} 
...
%enable begin/end theorem environment
\newtheorem{theorem}{Theorem}[section]
\newcommand{\theoremautorefname}{Theorem}

%enable begin/end proof environment
\newtheorem{proof}{Proof}[section]
\newcommand{\proofautorefname}{Proof}

%end of proof tombstone (q.e.d)
