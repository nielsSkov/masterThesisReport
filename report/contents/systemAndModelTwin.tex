...
\begin{table}[H]
  \begin{tabular}{|l|l|l|l|}
    ...
    \hline %-------------------------------------------------------------------------------------------
  \end{tabular}
  \caption{Table of all system parameters including the estimated parameters for the added second pendulum and with some updated notation for the augmented system.\label{table:systemParametersTwin} }
\end{table}
